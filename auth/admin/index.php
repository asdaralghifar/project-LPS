	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
				...
				<?php 
				$data = mysqli_query($con,"SELECT * FROM detail WHERE id_kategori='Terapi Perilaku (ABA)'");
				$data1 = mysqli_query($con,"SELECT * FROM detail WHERE id_kategori='Terapi Okupasi (OT)'");
				$data2 = mysqli_query($con,"SELECT * FROM detail WHERE id_kategori='Terapi Bicara (Speech)'");
				...
				<div class="page-inner">
					<div class="row">
						<div class="col-md-4">
							<div class="card card-dark bg-primary-gradient">
								<div class="card-body pb-0">
									...
									<h2 class="mb-2">...</h2>
									<p>Total Laporan Program Terapi Perilaku (ABA)</p>
						...
						<div class="col-md-4">
							<div class="card card-dark bg-secondary-gradient">
								<div class="card-body pb-0">
									...
									<h2 class="mb-2">...</h2>
									<p>Total Laporan Program Terapi Okupasi (OT)</p>
									<div class="pull-in sparkline-fix chart-as-background">
						...
						<div class="col-md-4">
							<div class="card card-dark bg-primary-gradient">
								<div class="card-body pb-0">
									<div class="h1 fw-bold float-right"><?php echo $jumlah2 ?></div>
									<h2 class="mb-2">...</h2>
									<p>Total Laporan Program Terapi Bicara (Speech)</p>
									<div class="pull-in sparkline-fix chart-as-background">
										<div id="lineChart"><canvas width="327" height="70" style="display: inline-block; width: 327px; height: 70px; vertical-align: top;"></canvas></div>
									</div>
								</div>
