							...
							<div class="card">
								...
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="cetak_detail.php" class="btn btn-danger btn-round ml-auto" target="_blank">Cetak</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
											...
											?>
												...
												<!-- echo "<td><a href='jadwal.php?id=".$jadwal['id']."' class='btn btn-danger ' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a>
													...
													<div class="form-button-action">
															...
															<!-- <a href="result.php?id=<php echo $daftar['nama']; ?>" class="btn btn-link btn-primary">
																<i class="fa fa-edit"></i>
															</a> -->
															<a href="detail.php?id=<?php echo $daftar['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-link btn-danger">
																<i class="fa fa-times"></i>
															</a>
														</div>
													</td>
													
													<td><?php echo $daftar['id_kategori']; ?></td>
													<td><?php echo $daftar['nama']; ?></td>
													<td><?php echo $daftar['terapis']; ?></td>
													<td><?php echo $daftar['tanggal']; ?></td>
													<td><?php echo $daftar['kegiatan']; ?></td>
													<td><?php echo $daftar['subk']; ?></td>
													<td><?php echo $daftar['pencapaian']; ?></td>
													<td><?php echo $daftar['penjelasan']; ?></td>													
												</tr>
												<?php }; ?>
											</tbody>
										</table>
