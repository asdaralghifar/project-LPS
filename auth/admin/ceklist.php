			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Laporan Perilaku</h4>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								if (isset($_GET['id']) == 'id') {
									$sql = "DELETE FROM `detail_list` WHERE `id`='$_GET[id]'";
								...
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="cetak_d.php" target="_blank" class="btn btn-danger btn-round ml-auto">Cetak</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
											...
											?>
												...
												<!-- echo "<td><a href='jadwal.php?id=".$jadwal['id']."' class='btn btn-danger ' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a>
													...
													<div class="form-button-action">
															...
															<a href="ceklist.php?id=<?php echo $daftar['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-link btn-danger">
