			...
			<div class="content">
				...
				<div class="page-inner">
					...
					<div class="page-header">
						...
						<h4 class="page-title">Daftar Kategori Kegiatan</h4>
						...
						<div class="col-md-12">
							...
							<div class="card">
								...
								if (isset($_GET['id']) == 'id') {
									...
									$sql = "DELETE FROM `kategori_kegiatan` WHERE `id`='$_GET[id]'";
								...
								$sql = "SELECT * FROM kategori_kegiatan";
								...
								<div class="card-header">
									...
									<div class="d-flex align-items-center">
										...
										<a href="tkategori.php" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i>Add</a>
											...
											?>
												...
												<!-- echo "<td><a href='jadwal.php?id=".$jadwal['id']."' class='btn btn-danger ' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a>
													...
													<div class="form-button-action">
															...
															<a href="dkategori.php?id=<?php echo $daftar['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-link btn-danger">
