							...
							<div class="card">
								...
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="tguru.php" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i>Add</a>
									</div>
								</div>
								<div class="card-body">
									<!-- Modal -->
											...
											?>
												...
												<!-- echo "<td><a href='jadwal.php?id=".$jadwal['id']."' class='btn btn-danger ' onclick=\"return confirm('Apakah anda yakin ingin menghapus data ini?') \">Delete</a>
													...
													<div class="form-button-action">
															...
															<a href="dguru.php?id=<?php echo $daftar['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-link btn-danger">
