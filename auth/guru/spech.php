...
<body>
   ...
   <div class="container-fluid bg-dark position-relative shadow">
    ...
    <div class="container" style="margin-top: 70px;">
        <form action="tambah_spech.php" method="POST">
            <div class="card m-4 p-4">
                <h4>Pengisian Formulir Program Terapi Bicara (Speech)</h4>
                ...
                <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <input type='hidden' name="id_kategori" value='Terapi Bicara (Speech)'>                   
               ...
               <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <?php  $sql = "SELECT * FROM kategori_kegiatan WHERE kategori = 'Terapi Bicara (Speech)'";
                        $query = mysqli_query($con, $sql);?>
                        <div class="form-group">
                ...
                <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <?php  $sql = "SELECT * FROM kegiatan WHERE kategori = 'Terapi Bicara (Speech)'";
                        $query = mysqli_query($con, $sql);?>
                        <div class="form-group">
                            <select name="subk" id="" class="form-control input-border-bottom">
