...
<body>
    ...
    <div class="container" style="margin-top: 70px;">
        <form action="tambah_ot.php" method="POST">
            <div class="card m-4 p-4">
                <h4>Pengisian Formulir Program Terapi Okupasi (OT)</h4>
                ...
                <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <input type='hidden' name="id_kategori" value='Terapi Okupasi (OT)'>                    
                ...
                <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <?php  $sql = "SELECT * FROM kategori_kegiatan WHERE kategori = 'Terapi Okupasi (OT)'";
                        $query = mysqli_query($con, $sql);?>
                        <div class="form-group">
                ...
                <div class="card bg-light mb-2">
                    <div class="card-body pl-3 pr-2 pb-0 pt-3">
                        ...
                        <?php  $sql = "SELECT * FROM kegiatan WHERE kategori = 'Terapi Okupasi (OT)'";
                        $query = mysqli_query($con, $sql);?>
                        <div class="form-group">
